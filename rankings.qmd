...
#### 26th Aug: automation for ranking not active yet

THE following table is a PLACEHOLDER.  
(similarly for the API <https://datacomp.opensky-network.org/api/rankings>)

PLEASE bear with us and wait for a little while more.
:::
...
import define from "https://api.observablehq.com/@espinielli/prc-data-challenge-2024-rankings@149.js?v=4";
