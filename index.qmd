...
We would like to praise the participation of the following organisations, companies
and individuals for their support in the provision of the data and infrastructure
for the challenge:
...
* Opensky Network: \acr{ADS-B} trajectories, hosting of the challenge infrastructure.
  (John, Allan, Martin, Vincent)
* TU Delft (Prof Junzi Sun): for wisely pre-process, enhance and store OSN 
  trajectories made available for the challenge
* EUROCONTROL: flight list (network Manager) and estimating \acr{TOW}
