...
Please send a team creation email with the following info (this will be publicly
...
After a little while later, you will receive the relevant access/secret keys
to obtain the relevant [Data](data.html) using your \acr{OSN} account.
