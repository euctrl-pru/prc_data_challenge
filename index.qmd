...
## The Data
The data sets for the challenge are:

* flight list for flown flights in Europe in 2023
* associated (\acr{ADS-B} based) flown trajectories augmented with wind information (from Copernicus/ERA5)
...
* Why is the challenge focusing on \acr{ATOW}?  
  ...
  percentage of the \acr{MTOW}. With this challenge we aim at making available a better way to
  estimate \acr{ATOW}.
